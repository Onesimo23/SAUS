...
@section('content')
    <div class="container mx-auto p-6">
        <h1 class="text-3xl font-semibold text-gray-800 dark:text-gray-100 mb-6">Editar Projeto</h1>
        ...
        <form action="{{ route('projects.update', $project->id) }}" method="POST">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <x-input id="name" type="text" name="name" value="{{ $project->name }}" required />
                </div>
                <div>
                    <x-label for="description" value="Descrição" />
                    <x-input id="description" type="text" name="description" value="{{ $project->description }}" required />
                </div>
            </div>
